...
export default async function main() {
  ...
  // const parsedProgramImplementationFee = hre.ethers.utils.formatEther(programImplementationDeploymentFee.toString());
  ...
  // const parsedQuadraticFundingVotingStrategyFee = hre.ethers.utils.formatEther(quadraticFundingVotingStrategyFee.toString());
